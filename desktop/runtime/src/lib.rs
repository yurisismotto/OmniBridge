...
//! trait — [`pliwee_control::transport::ControlTransport`] for the control
//! endpoint, [`pliwee_core::secret_store::SecretStore`] for persistence —
//! and the adapter crate supplies it. `pliwee-linux` is the only adapter
//! Wave 0 ships.
//!
