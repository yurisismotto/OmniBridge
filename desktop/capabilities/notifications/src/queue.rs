...
//!
//! `pliwee_core::session` awaits `Capability::on_message` before reading the
...
use pliwee_core::notifications::NotificationId;
...
pub enum Work {
    ...
    Sync(pliwee_proto::v1::capabilities::SyncMarker),
