package io.github.yurisismotto.pliwee.notifications
 ...
 */
class PliweeNotificationListener : NotificationListenerService() {
    ...
    private val control = object : NotificationSource.ListenerControl {
        override fun requestUnbind() {
            runCatching { this@PliweeNotificationListener.requestUnbind() }
        }
...
object NotificationAccess {
    ...
    fun component(context: Context): ComponentName =
        ComponentName(context.applicationContext, PliweeNotificationListener::class.java)
