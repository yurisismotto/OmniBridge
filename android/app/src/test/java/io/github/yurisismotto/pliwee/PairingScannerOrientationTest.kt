...
import io.github.yurisismotto.pliwee.ui.PairingCaptureActivity
...
class PairingScannerOrientationTest {
    ...
    private val validCode = "omnibridge1:$fingerprintHex:$tokenBase32:$deviceId:192.168.1.10:55432"
    ...
    fun `an arbitrary uri is still not a pairing code`() {
        val rejected = listOf(
            ...
            "omnibridge9:$fingerprintHex:$tokenBase32:$deviceId:10.0.0.1:1",
            "",
            "omnibridge1:not-hex:$tokenBase32:$deviceId:10.0.0.1:1",
        )
    ...
    fun `a rejected outcome carries none of the scanned text`() {
        val secret = "omnibridge1:$fingerprintHex:$tokenBase32:$deviceId"
