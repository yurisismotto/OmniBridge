...
import io.github.yurisismotto.pliwee.NotificationUiFixtures as Fx
...
import io.github.yurisismotto.pliwee.ui.AppPickerScreen
...
class AppPickerUiTest {
    ...
    private fun show(
        ...
        apps: List<io.github.yurisismotto.pliwee.notifications.NotificationApp> = catalogue,
