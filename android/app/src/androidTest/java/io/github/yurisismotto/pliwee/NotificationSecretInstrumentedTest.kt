...
import io.github.yurisismotto.pliwee.notifications.NotificationIdentity
...
class NotificationSecretInstrumentedTest {
    ...
    private val testAlias = "pliwee-notification-secret-instrumented-test"
    ...
    fun thisSuiteDoesNotTouchTheProductionAlias() {
        ...
        assertTrue(NotificationSecret.KEY_ALIAS == "pliwee-notification-secret-v1")
    }
}
